...
SEQUENCE_LENGTH=10 ;Time from lights appearing on screen to all lights being red in seconds.
SEQUENCE_START=8 ;Time to start turning on lights in seconds, should be lower than SEQUENCE_LENGTH.
