...
ac.StructItem.key("PenaltyZone"),
warns=ac.StructItem.uint8(),
eventType = ac.StructItem.uint8() --Event Types, 0 = random Broadcast, 1 = Cut Warning, 2 = Served Penalty
